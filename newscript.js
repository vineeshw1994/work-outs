...
//  function mail_Cheaker(){
//   const email_checcking = document.getElementById('inputEmail')
//   let checking = email_checcking.value
//   if (checking=="" || !email.value.match(/^([a-zA-Z0-9_\-?\.?]){3,}@([a-zA-Z]){3,}\.([a-zA-Z]){2,5}$/)){
...
//  }
  ...
  function validatePlace() {
    ...
    if (place.value.trim() == "" || !place.value.match(/^[A-Za-z0-9_]/)) {
